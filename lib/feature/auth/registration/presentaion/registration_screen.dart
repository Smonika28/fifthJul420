...
import 'package:four20society/utils/Api/validate/validation.dart';
                ...
                children: [
                  ...
                  InputFieldWidget(
                    ...
                    validator: (value) {
                      ...
                      if (passwordController.text != cnfPassController.text) {
                      ...
                      onTap: () {
                        if (_formKey.currentState!.validate()) {
                          BlocProvider.of<SignupBloc>(context).add(
                            ...
                            cnfPassController: cnfPassController.text.trim(),
